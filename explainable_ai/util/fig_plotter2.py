...
def plot_learning_vs_no_learning():
    ...
    for title in [
        ...
        data = {
            'V1explainable_learning': [],
            'V2explainable_learning': []
        }

        for file_name in ['V1explainable_learning', 'V2explainable_learning']:
            path = 'data/results/both/'
        ...
        print({
            'title': title,
            'V1explainable_learning_avg': np.average(data['V1explainable_learning']),
            'V2explainable_learning_avg': np.average(data['V2explainable_learning'])
        })

        plt.subplot(2, 2, plt_index)

        boxplot = plt.boxplot(
            [data[x] for x in ['V1explainable_learning', 'V2explainable_learning']],
            positions=[1, 2],
            widths=.3,
            labels=['DeltaIoTv1', 'DeltaIoTv2'],
            patch_artist=True,
            #showfliers=False,
            #notch=True,
